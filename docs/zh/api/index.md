...
| 符号 | 覆盖 | 更多 |
|---|---|---|
| `StatefulAgentLoop` | `new_session`、`send`、`send_sync`、`resume`、`abort_pending`、`close_session`、`get_messages`、`get_pending` | [会话](../user-guide/sessions.md)、[源码](../../../power_loop/agent/stateful_loop.py) |
